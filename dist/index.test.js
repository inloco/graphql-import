...
ava_1.default('importSchema: import .gql extension', function (t) {
    var expectedSDL = "type A {\n  id: ID!\n}\n";
    t.is(_1.importSchema('fixtures/import-gql/a.gql'), expectedSDL);
});
...
ava_1.default('importSchema: key directive', function (t) {
    var expectedSDL = "scalar UPC\n\ntype Product @key(fields: \"upc\") {\n  upc: UPC!\n  name: String\n}\n";
    t.is(_1.importSchema('fixtures/directive/c.graphql'), expectedSDL);
});
ava_1.default('importSchema: multiple key directive', function (t) {
    var expectedSDL = "scalar UPC\n\nscalar SKU\n\ntype Product @key(fields: \"upc\") @key(fields: \"sku\") {\n  upc: UPC!\n  sku: SKU!\n  name: String\n}\n";
    t.is(_1.importSchema('fixtures/directive/e.graphql'), expectedSDL);
});
ava_1.default('importSchema: external directive', function (t) {
    var expectedSDL = "type Review @key(fields: \"id\") {\n  product: Product @provides(fields: \"name\")\n}\n\nextend type Product @key(fields: \"upc\") {\n  upc: String @external\n  name: String @external\n}\n";
    t.is(_1.importSchema('fixtures/directive/f.graphql'), expectedSDL);
});
ava_1.default('importSchema: requires directive', function (t) {
    var expectedSDL = "type Review {\n  id: ID\n}\n\nextend type User @key(fields: \"id\") {\n  id: ID! @external\n  email: String @external\n  reviews: [Review] @requires(fields: \"email\")\n}\n";
    t.is(_1.importSchema('fixtures/directive/g.graphql'), expectedSDL);
});
...
ava_1.default('extend root field', function (t) {
    var expectedSDL = "extend type Query {\n  me: User\n}\n\ntype User @key(fields: \"id\") {\n  id: ID!\n  name: String\n}\n";
    var actualSDL = _1.importSchema('fixtures/root-fields/c.graphql');
    t.is(actualSDL, expectedSDL);
});
ava_1.default('extend root field imports', function (t) {
    var expectedSDL = "extend type Query {\n  me: User\n  post: Post\n}\n\ntype Post {\n  id: ID!\n}\n\ntype User @key(fields: \"id\") {\n  id: ID!\n  name: String\n}\n";
    var actualSDL = _1.importSchema('fixtures/root-fields/d.graphql');
    t.is(actualSDL, expectedSDL);
});
